...
<?php include('support_files/header.php'); ?>

<!-- START SECTION BANNER -->
<section id="home_section" style="background:url(demo-mobile-app/images/banner.jpg);background-size: cover;background-repeat: no-repeat;background-position: left center;">
        ...
        <div class="row align-items-center">
            ...
            <!--<div class="col-lg-6 order-lg-first">
                <div class="banner_content2 text_white animation" data-animation="fadeIn" data-animation-delay="0.3s">
                    <h1 class="animation" data-animation="fadeInLeft" data-animation-delay="1s">We Create Awesome App to Represent Your Life</h1>
                    <p class="animation mt-md-4 mt-2 mb-4" data-animation="fadeInLeft" data-animation-delay="0.5s">Anger Software Tech designed and develop world class products that provides you the results that you always wanted</p>
	...
	<div class="container">
    	<div class="row justify-content-center">
        	<div class="col-lg-6 col-md-9 text_white">
                ...
                <p class="text-center animation" data-animation="fadeInUp" data-animation-delay="0.4s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc id varius nunc.</p>
            </div>
        </div>
    	<div class="row align-items-center">
        	<div class="col-lg-4">
                ...
                <div class="icon_box text_white icon_right icon_box_style_12 text-lg-right animation" data-animation="fadeInUp" data-animation-delay="0.8s">
                 ...
                 <div class="icon_box text_white icon_right icon_box_style_12 text-lg-right animation" data-animation="fadeInUp" data-animation-delay="0.9s">
                    ...
                    <div class="icon_box_content">
                        ...
                        <p>Making this the first true generator on the Internet error.</p>
                    </div>
                 </div>
            </div>
            <div class="col-lg-4">
            	<div class="py-4 px-lg-4 animation text-center"  data-animation="fadeInUp" data-animation-delay="0.2s">
            		<img src="demo-mobile-app/images/features.png" alt="vector1"> 
                </div>
            </div>
        	<div class="col-lg-4">
...
<section id="about">
    <div class="container">
        ...
        <div class="row align-items-center flex-row-reverse">
            <div class="col-lg-6 col-md-6 col-sm-12"> 
                <div class="mb-4 mb-lg-0 animation" data-animation="fadeInLeft" data-animation-delay="0.1s">
                    <img src="demo-mobile-app/images/vector4.png" alt="vector2"> 
                </div>
            </div>
            <div class="col-lg-6 pl-lg-5 col-md-6 col-sm-12 animation" data-animation="fadeInRight" data-animation-delay="0.1s">
                <div class="heading_s2">
                    <h3>Best Way To Promote Your App</h3>
                </div>
                <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary</p>
                <p>There are many variations of passages of Lorem Ipsum, but the majority have suffered alteration in some form</p>
